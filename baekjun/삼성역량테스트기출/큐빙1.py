...
def counterclock(order,cube):
    if order == 'U':
        ...
        start = [cube[0][0][0],cube[0][0][1],cube[0][0][2]]
        for i in range(3):
            cube[0][0][i] = cube[4][i][0]
        for i in range(3):
            cube[4][i][0] = cube[1][2][i]
        for i in range(3):
            cube[1][2][i] = cube[5][i][2]
        for i in range(3):
            cube[5][i][2] = start[i]
...
def clock(order,cube):
    if order == 'U':
        ...
        for i in range(3):
            cube[1][0][i] = cube[5][i][0]
        for i in range(3):
            cube[5][i][0] = start[i]


    elif order == 'B':
        start = [cube[4][0][0],cube[4][1][0],cube[4][2][0]]
        for i in range(3):
            cube[4][i][0] = cube[0][0][i]
        for i in range(3):
